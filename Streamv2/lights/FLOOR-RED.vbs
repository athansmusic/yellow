' Stuck H6076 floor lamps (.84 + .85): hold red
...
shell.Run "pythonw.exe " & Chr(34) & here & "\lan_hold.py" & Chr(34) & " 192.168.4.84,192.168.4.85 255 0 0 --once 192.168.4.133", 0, False

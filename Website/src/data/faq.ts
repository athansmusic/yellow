...
export const QA: { q: string; a: string; link?: { href: string; label: string }; group: FaqGroup; top?: boolean }[] = [
  ...
  { q: "Who voices Jacob Kane? Who makes the show?", a: "Jacob is voiced by Jamie Petronis! Created by Athan (Johnathan Magno) and Jamie Petronis. Athan plays Eli Reyes. Produced by Hush Studios. Show art by 7cfc00.", link: { href: "/cast", label: "Full cast" } , group: "show" },
